...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 17:37:41 2018

@author: Razvan, updated by Anaïs
Language: python3

gofrs_umd.py program to compute pair-distribution fuctions g(r) and print all the results into one file

Attention, only for NVT ensemble and cubic cell and a constant timestep
"""
